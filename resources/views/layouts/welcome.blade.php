...
<body class="bg-default">
    <!-- Navbar -->
    @auth
    <nav class="navbar navbar-top navbar-horizontal navbar-expand-md navbar-dark fixed-top">
                ...
                <ul class="navbar-nav ml-auto">
                    @if (auth()->user()->role->role == "Guru")
                        <li class="nav-item">
                            <a href="{{ route('users.index') }}" class="nav-link nav-link-icon">
                                ...
                                <span class="nav-link-inner--text">Profile Siswa</span>
                            </a>
                        </li>
                    @endif
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link nav-link-icon" href="{{ route('profil') }}">
                            ...
                            <span class="nav-link-inner--text">Profile Users</span>
                        </a>
                    </li>
                ...
                <div class="header-body text-center mb-7">
                    <div class="row justify-content-center">
                        <div class="col-lg-5 col-md-6">
                            <h1 class="text-white">SIPRESDIN</h1>
                            <p class="text-lead text-light">Madrasah Diniyah Takmiliyah (MDT) Al-Hidayah</p>
                        </div>
                    </div>
                </div>
            </div>
