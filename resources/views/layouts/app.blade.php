...
<body class="">
    <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white fixed-top" id="sidenav-main">
                    ...
                    <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true"
                        ...
                        <div class="media align-items-center">
                            ...
                            <img alt="Image placeholder" 
                                src="{{ Auth::user()->foto ? asset('storage/'.Auth::user()->foto) : asset('images/default-avatar.jpg') }}" 
                                alt="{{ Auth::user()->nama }}">
                            </span>
                        </div>
                    </a>
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    @if (auth()->user()->role->role == "Guru")
                        ...
                        @endif
                                <i class="ni ni-circle-08 text-primary"></i> Profile Siswa
                            </a>
                        </li>
                    @else
                    ...
                    @endif
                            <i class="ni ni-single-02 text-yellow"></i> Profile Users
                        </a>
                    </li>
    ...
    <div class="main-content">
        <!-- Navbar -->
        <nav class="navbar navbar-top navbar-expand-md navbar-dark fixed-top" id="navbar-main">
            <div class="container-fluid">
                <!-- Brand -->
                ...
                <div class="row align-items-center justify-content-xl-between">
                    <div class="col-xl-6">
                        <div class="copyright text-center">
                            © {{ date('Y') }} Developed by Team 2 Informatics A Siliwangi University
                        </div>
                    </div>
                </div>
            </footer>
