        ...
        <div class="col-md-6">
            <div class="card shadow h-100">
                <div class="card-header">
                    <h5 class="m-0 pt-1 font-weight-bold float-left">Ubah Siswa</h5>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control @error('role') is-invalid @enderror" name="role" id="role">
                                    ...
                                    <option value="1" {{ old('role',$user->role_id) == 1 ? 'selected' : '' }}>Guru</option>
                                    <option value="2" {{ old('role',$user->role_id) == 2 ? 'selected' : '' }}>Siswa</option>
                                </select>
